...
import { ArrowLeft, Briefcase, Activity, CheckCircle2, AlertCircle, Database, Megaphone, Wrench, Sparkles, Globe } from "lucide-react";
        ...
        <CardContent className="p-4">
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            ...
            >
              ...
              <div>
                <p className="font-medium">ตัวแทนประกัน</p>
                <p className="text-[11px] text-muted-foreground">อนุมัติ + ตั้ง default + พักการใช้</p>
              </div>
            </Link>
            <Link
              href="/admin/products"
            ...
            >
              ...
              <div>
                <p className="font-medium">Product Catalog · AI Sync</p>
                <p className="text-[11px] text-muted-foreground">ดึงข้อมูลผลิตภัณฑ์ประกันจากเว็บไซต์ (AI auto-sync)</p>
              </div>
            </Link>
            <Link
