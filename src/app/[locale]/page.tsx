...
// 8 screenshot showcase rows (alternating layout)
const showcaseRows = [
  { tag: 'row1', img: '/marketing/dashboard.png',       alt: 'Lumenfi Dashboard',     icon: LineChart },
  { tag: 'row2', img: '/marketing/networth-chart.png',  alt: 'Net Worth Chart',       icon: TrendingUp },
  { tag: 'row3', img: '/marketing/add-transaction.png', alt: 'Quick Transaction Log', icon: Camera },
  { tag: 'row4', img: '/marketing/cashflow.png',        alt: 'Cash Flow',             icon: Wallet },
  { tag: 'row5', img: '/marketing/advisor-home.png',    alt: 'AI Advisor',            icon: Brain },
  { tag: 'row6', img: '/marketing/budget.png',          alt: 'Monthly Budgets',       icon: Calculator },
  { tag: 'row7', img: '/marketing/debt-plan.png',       alt: 'Debt Payoff Plan',      icon: Receipt },
  { tag: 'row8', img: '/marketing/health-report.png',   alt: 'Financial Health',      icon: HeartPulse },
] as const;
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF7] text-[#0F172A]">
      ...
      <section className="border-y border-black/5 bg-white">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 px-4 py-10 md:grid-cols-4 md:gap-8">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="text-center">
              <div className="text-3xl font-bold text-[#0F172A] md:text-4xl">
                {t(`stat${i}Num`)}
              </div>
              ...
              return (
                ...
                >
                  <CardContent className="pt-5">
                    <div
                      className={`mb-3 inline-flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-[#0F172A] to-[#1E293B] text-[#C9A45A]`}
                    >
      ...
      {/* ─────────────── Showcase rows (8) ─────────────── */}
      <section className="bg-gradient-to-b from-[#FAFAF7] via-white to-[#FAFAF7] px-4 py-16">
        <div className="mx-auto max-w-6xl">
