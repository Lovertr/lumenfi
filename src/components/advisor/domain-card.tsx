...
export function DomainCard({ domain, title, description, icon, color, hero = false }: Props) {
  ...
  const errorText: Record<string, string> = {
    ...
    no_advisor_quota: 'ใช้ครบ quota เดือนนี้แล้ว — อัพเกรด Pro หรือซื้อ Credit pack',
    free_advisor_quota_exceeded: '🔒 ใช้ AI Advisor ฟรีครบ 1 รายงาน/เดือนแล้ว — อัพเกรด Pro ใช้ไม่จำกัด',
    no_ai_access: 'ต้องอัพเกรด Pro หรือซื้อ Credit pack (BYO Key ใช้กับ AI Advisor ไม่ได้)',
    ...
    secretary_pro_only: 'AI Secretary เป็นฟีเจอร์ของ Pro — อัพเกรดที่ /pricing',
