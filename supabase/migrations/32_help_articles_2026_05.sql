...
-- ─────────── Phase 1 pricing update — AI Advisor as Pro hero ───────────
insert into help_articles (slug, title, category, body, locale, sort_order) values
('feat2026-ai-advisor-pricing', 'AI Advisor 8 มิติ — ฟรี vs Pro', 'subscription',
E'# AI Advisor — พระเอกของ Lumenfi\n\nAI Advisor คือรายงานวิเคราะห์เชิงลึก 8 มิติที่ใช้ข้อมูลการเงินจริงของคุณ ไม่เหมือน AI Chat ทั่วไป — มันรู้จักคุณ ใช้ตัวเลขของคุณ ตอบเฉพาะคุณ\n\n## ทำไมเป็นฟีเจอร์เสียเงิน?\n\nต้นทุน AI ในการสร้าง 1 รายงาน 8 มิติ = ~฿0.7-3 (ค่า token ของ Claude/Gemini)\n- 1 รายงาน ใช้ token ~10,000-15,000 token\n- AI ต้องอ่านข้อมูลคุณทั้งหมด (รายรับ-รายจ่าย หนี้ การลงทุน ประกัน เป้าหมาย ฯ)\n- คิด analysis + เขียน 5,000-8,000 character\n\nต้นทุนสะสมรายเดือนสำหรับ user 1 คน = ฿20-90 → จะให้ฟรีไม่ได้ ถ้าฟรีทุกคน Lumenfi จะ unsustainable\n\n## ฟรี vs Pro vs Pay-as-you-go\n\n| | Free | Pay-as-you-go | Pro |\n|---|:---:|:---:|:---:|\n| AI Advisor 8 มิติ | **1 รายงาน/เดือน** | ฿7-8/รายงาน (ซื้อ pack) | **ไม่จำกัด** |\n| AI Chat (Lumenfi key) | 5 ข้อความ/วัน | 5 ข้อความ/วัน | ไม่จำกัด |\n| AI Chat (BYO key ของคุณเอง) | ✅ ไม่จำกัด | ✅ ไม่จำกัด | ✅ |\n| OCR สแกนใบเสร็จ | ✅ ไม่จำกัด | ✅ | ✅ |\n| AI Secretary push เตือนทุกวัน | ❌ | ❌ | ✅ |\n\n## ⚠️ BYO Key ใช้กับ AI Advisor ไม่ได้\n\n**สำคัญ:** ถึงคุณตั้ง BYO Key ของคุณเอง (Anthropic / OpenAI / Gemini / OpenRouter) ที่ /ai/settings ก็จะใช้กับ:\n- ✅ AI Chat — ไม่จำกัด\n- ✅ OCR สแกนใบเสร็จ — ไม่จำกัด\n- ❌ **AI Advisor 8 มิติ — ไม่อนุญาต**\n\nเพราะ AI Advisor เป็นฟีเจอร์พรีเมียมที่ต้องประมวลผลบน server ของ Lumenfi ด้วย key พิเศษที่ปรับ tune แล้วเฉพาะ\n\n## วิธีอัพเกรด\n- **Pro ฿149/เดือน** (หรือ ฿1,490/ปี · ประหยัด 17%) — ทดลองฟรี 14 วัน ไม่ผูกบัตร\n- **Credit pack** ฿79-599 — ไม่หมดอายุ ใช้เมื่อต้องการ\n\nไปที่ /pricing เพื่อเลือก', 'th', 251);
